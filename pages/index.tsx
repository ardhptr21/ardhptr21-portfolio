...
import VerticalTimeLineContainer from '../components/VerticalTimeline/VerticalTimeLineContainer';
import VerticalTimelineItem from '../components/VerticalTimeline/VerticalTimelineItem';
import isCurrentYear from '../utils/isCurrentYear';
    ...
    <>
      ...
      <Layout>
        ...
        <Section id="educations">
          <Title>Educations History</Title>
          <VerticalTimeLineContainer>
            <VerticalTimelineItem
              date={`2020 - ${isCurrentYear(2024)}`}
              title="SMK N 7 Semarang"
              description="Network Information Systems and Applications"
              icon="1"
            />
            <VerticalTimelineItem
              date={`2017 - ${isCurrentYear(2020)}`}
              isRight={true}
              title="SMP N 1 Boja"
              description="One of the favorite Junior High Schools"
              icon="2"
            />
            <VerticalTimelineItem
              date={`2011 - ${isCurrentYear(2017)}`}
              title="SD N 5 Meteseh"
              icon="3"
